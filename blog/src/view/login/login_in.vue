  ...
  <div class="login">
    ...
    >
      ...
      <el-form-item prop="username">
        <el-input type="text" v-model="account.accounts" auto-complete="off" placeholder="账户"></el-input>
      </el-form-item>
      <el-form-item prop="pwd">
        <el-input type="password" v-model="account.email" auto-complete="off" placeholder="邮箱"></el-input>
      </el-form-item>
      <div class="forget">
